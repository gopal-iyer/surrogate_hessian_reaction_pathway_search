...
run_dmc = True
add_sigma = False
window_frac = 0.25 # use 0.25 for saddle, 0.1 for eqm
epsilon_p = [0.01, 0.05]
shift_params = [0.05, 0.25] # not used for DMC
n_ls_iter = 4
n_warmup = 2

displaced_guess_params = np.array([0.98914004, 1.37690419]) # used for DMC - this is a point on the DMC pathway that is NOT the saddle point
...
#GRI USE THIS SECTION FOR DMC SEARCH
    ...
    lsi = LineSearchIteration(
        ...
        shift_params = displaced_guess_params - surrogate.structure.params
    )
