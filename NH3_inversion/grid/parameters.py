...
def backward(params):
    ...
    x0 = r_NH * cos(theta) #GRI switching to radians for meaningful non-diagonality
    yz0 = r_NH * sin(theta) #GRI switching to radians for meaningful non-diagonality
    p0 = [x0, yz0]
...
convapp = 'convert4qmc'
qmcjob = obj(app=qmcapp, cores=cores, ppn=cores, hours = 12)
